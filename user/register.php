...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($password !== $confirm_password) {
        ...
        if($stmt->rowCount() > 0) {
            ...
            $stmt = $pdo->prepare("INSERT INTO users (username, email, password, full_name, phone, date_of_birth) VALUES (?, ?, ?, ?, ?, ?)");
            if($stmt->execute([$username, $email, $hashed_password, $full_name, $phone, $date_of_birth])) {
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6">
                    ...
                    <div class="register-card">
                        <h2 class="text-white mb-4 text-center">Join Nextflix</h2>
                    ...
                    <!-- <div class="demo-credentials">
                        ...
                        <div class="text-light">
                            <small>
                                ...
                                Make sure to choose a strong password for your account security.
                            </small>
                        </div>
                    </div> -->
                </div>
